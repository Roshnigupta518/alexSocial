...
import {getBusinessListingByIdRequest} from '../../../services/Utills';
...
const SelectedBusinessListingScreen = ({navigation, route}) => {
  ...
  const getBusinessList = () => {
    setIsLoading(true);
    getBusinessListingByIdRequest(route?.params?.subCatId)
      .then(res => {
  ...
  return (
    <>
      <CustomContainer>
        <BackHeader label="Business Listing" />
...
export default SelectedBusinessListingScreen;
